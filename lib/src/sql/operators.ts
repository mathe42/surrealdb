...
import { alt, char, map, tag, tag_no_case, tuple } from "./_base.ts";
...
export const phrases = tuple(
  ...
  alt(
    ...
    alt(
      map(tag_no_case("CONTAINSALL"), {
        type: "operator",
        value: "ContainAll",
      }),
      map(tag_no_case("CONTAINSANY"), {
        type: "operator",
        value: "ContainAny",
      }),
      map(tag_no_case("CONTAINSNONE"), {
        type: "operator",
        value: "ContainNone",
      }),
      map(tag_no_case("CONTAINSNOT"), {
        type: "operator",
        value: "NotContain",
      }),
